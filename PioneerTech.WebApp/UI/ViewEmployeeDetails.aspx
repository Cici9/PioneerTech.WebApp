<%@ Page Title="View Employee Details - Pioneer Technologies Inc." Language="C#" MasterPageFile="~/UI/PioneerTechMasterPage.Master" AutoEventWireup="true" CodeBehind="ViewEmployeeDetails.aspx.cs" Inherits="PioneerTech.WebApp.UI.ViewEmployeeDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    ...
    <p>You can view a particular Employee's details here.</p>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="EmployeeIDDropDownList" runat="server" AutoPostBack="true" AppendDataBoundItems="true" OnSelectedIndexChanged="EmployeeIDDropDownList_SelectedIndexChanged"></asp:DropDownList>
